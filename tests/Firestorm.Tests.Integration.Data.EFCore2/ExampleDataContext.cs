    ...
    public class ExampleDataContext : DbContext
    {
        ...
        private static DbContextOptions GetOptions()
        {
            return new DbContextOptionsBuilder<ExampleDataContext>()
                .UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Firestorm.Tests.Integration.Data.EntityFramework.ExampleDataContext;integrated security=True;Trusted_Connection=True;MultipleActiveResultSets=true")
                .Options;
        }
